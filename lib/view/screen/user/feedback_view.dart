...
import '../../../controller/usercontroller/feedback_controller.dart';

class FeedbackStudentView extends StatelessWidget {
  final String instructorId;
  const FeedbackStudentView({super.key, required this.instructorId});

  @override
  Widget build(BuildContext context) {
    final ctrl = Get.put(FeedbackController());
    ctrl.init(instructorId);
