...
import 'package:tadreebkomapplication/controller/auth/verifycodecentercontroller.dart';
...
import 'package:tadreebkomapplication/core/functions/alertexitappverifycodecenter.dart';
import 'package:tadreebkomapplication/view/widget/auth/textsignup.dart';

class VerifyCodeCenterSignUp extends StatelessWidget {
  const VerifyCodeCenterSignUp({super.key});

  @override
  Widget build(BuildContext context) {
    final VerifyCodeCenterControllerImp controller = Get.put(
      VerifyCodeCenterControllerImp(),
    );
    ...
    return Scaffold(
      ...
      body: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) async {
          if (!didPop) {
            final shouldPop = await alertExitAppVerifyCenter();
            if (shouldPop) {
                ...
                () => TextButton(
                  onPressed:
                      timerController.canResend.value
                          ? () {
                            controller.centerLocationController
                                .sendOtpVerification();
                            timerController
