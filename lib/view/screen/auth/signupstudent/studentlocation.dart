...
import 'package:tadreebkomapplication/core/constant/color.dart' show AppColor;
...
class StudentLocation extends StatelessWidget {
  const StudentLocation({super.key});

  @override
  Widget build(BuildContext context) {
    final StudentLocationControllerImp controller = Get.put(
          ...
          child: ListView(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Please put your location on the map, and confirm your address location",
              ...
              SizedBox(
                ...
                child: GetBuilder<StudentLocationControllerImp>(
                  builder: (controller) {
